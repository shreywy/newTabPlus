...
const backgroundSizes = [235,252,150,253,204,134,179,299,215,281,158,210]
  .flatMap(h => [`300px ${h}px`, `300px ${h}px`, `300px ${h}px`])
  .join(', ');
...
export default function FallingPattern({ color = '#2596be', duration = 150 }) {
  return (
    <motion.div
      style={{
        position: 'absolute',
        inset: 0,
        backgroundImage: generateBg(color),
        backgroundSize: backgroundSizes,
        backgroundRepeat: 'repeat',  // KEY FIX: tiles horizontally AND vertically
      }}
